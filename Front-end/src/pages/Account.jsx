...
const Account = () => {
  ...
  console.log(typeof allergy_list)
  console.log(allergy_list)
  let ht = ''
  if (allergy_list != [])   {
    for (let i = 0; i < allergy_list.length; i++) {
      ht += <p>{allergy_list[i]}</p>
    }
  }
    ...
    <div className="flex justify-center translate-y-36">
        <div className="flex flex-col items-center p-6 w-[40vw] h-[60vh] rounded-3xl  shadow-xl">
            <div>
              ...
              <input id="allergyin" type='text'></input>
